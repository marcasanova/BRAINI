        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="relative max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 items-stretch relative">
              <div
                className="rounded-3xl p-6 sm:p-7 shadow-xs flex flex-col"
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="hidden lg:block">
            <div className="flex items-center justify-center gap-3 xl:gap-6">
              ...
              <div className="flex-1 min-w-6 h-3 rounded-full" style={{ background: '#7ea4df' }} />
              ...
              <div className="flex-1 min-w-6 h-3 rounded-full" style={{ background: '#35bdb1' }} />
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto min-w-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="bg-white/85 backdrop-blur-sm rounded-xl p-6 shadow-xs">
          ...
          <div className="mt-6 sm:mt-8">
            <div className="bg-white/85 backdrop-blur-sm rounded-xl p-6 shadow-xs max-w-4xl mx-auto text-center">
              <p className="font-bold text-gray-900 text-lg sm:text-xl mb-2" style={{ fontWeight: 800 }}>
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto min-w-0 px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
          <div className="min-h-[min(22rem,52dvh)] sm:min-h-[min(24rem,48dvh)] md:min-h-[min(26rem,45dvh)] lg:min-h-[min(28rem,42dvh)] flex items-center py-4 md:py-6">
            <div
              className="bg-braini-blue rounded-2xl p-6 sm:p-8 md:p-10 w-full max-w-xl min-w-0"
              style={{
        ...
        <div className="max-w-6xl xl:max-w-7xl mx-auto min-w-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 min-w-0">
            {[
              ...
              <div
                key={idx}
                className="min-w-0 bg-white/90 rounded-xl p-6 shadow-xs border border-white/50 backdrop-blur-xs"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start min-w-0">
            ...
            <div className="space-y-2 min-w-0">
              ...
              <a
                ...
                className="flex items-center text-white text-sm hover:text-white/90 wrap-break-word"
                aria-label={`Enviar email a ${CONTACT_EMAIL}`}
              >
                <svg className="w-4 h-4 mr-2 shrink-0" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
