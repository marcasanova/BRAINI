      ...
      <div className="mt-3 md:mt-0 md:ml-6 flex items-center gap-3 sm:gap-4 w-full md:w-auto">
        ...
        {isAccessible ? (
          <Link
            ...
            className="ml-auto md:ml-0 inline-block px-4 py-2.5 sm:px-6 sm:py-3 bg-braini-blue text-white text-sm sm:text-base font-semibold rounded-lg shadow-sm hover:bg-braini-blue-dark transition disabled:opacity-50"
          >
            Acceder
          </Link>
        ) : (
