...
export type { Child } from "@/products/brainifamily/contexts/CurrentChildContext";
...
export function useCurrentChild() {
  ...
  const [fallbackChild, setFallbackChild] = useState<import("@/products/brainifamily/contexts/CurrentChildContext").Child | null>(null);
